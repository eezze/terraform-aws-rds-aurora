...
output "rds_cluster_arn" {
  ...
  value       = element(concat(aws_rds_cluster._.*.arn, [""]), 0)
}

output "rds_cluster_id" {
  description = "The ID of the cluster"
  value       = element(concat(aws_rds_cluster._.*.id, [""]), 0)
}

output "rds_cluster_resource_id" {
  description = "The Resource ID of the cluster"
  value       = element(concat(aws_rds_cluster._.*.cluster_resource_id, [""]), 0)
}

output "rds_cluster_endpoint" {
  description = "The cluster endpoint"
  value       = element(concat(aws_rds_cluster._.*.endpoint, [""]), 0)
}

output "rds_cluster_engine_version" {
  description = "The cluster engine version"
  value       = element(concat(aws_rds_cluster._.*.engine_version, [""]), 0)
}

output "rds_cluster_reader_endpoint" {
  description = "The cluster reader endpoint"
  value       = element(concat(aws_rds_cluster._.*.reader_endpoint, [""]), 0)
}
...
output "rds_cluster_master_password" {
  ...
  value       = element(concat(aws_rds_cluster._.*.master_password, [""]), 0)
  sensitive   = true
}

output "rds_cluster_port" {
  description = "The port"
  value       = element(concat(aws_rds_cluster._.*.port, [""]), 0)
}

output "rds_cluster_master_username" {
  description = "The master username"
  value       = element(concat(aws_rds_cluster._.*.master_username, [""]), 0)
  sensitive   = true
}

output "rds_cluster_hosted_zone_id" {
  description = "Route53 hosted zone id of the created cluster"
  value       = element(concat(aws_rds_cluster._.*.hosted_zone_id, [""]), 0)
}
...
output "rds_cluster_instance_ids" {
  ...
  value       = aws_rds_cluster_instance._.*.id
}
...
output "rds_cluster_instance_dbi_resource_ids" {
  ...
  value       = aws_rds_cluster_instance._.*.dbi_resource_id
}
